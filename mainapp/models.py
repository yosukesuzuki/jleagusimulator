...
class JPlayerData(db.Model):
    year = db.StringProperty(verbose_name=_('Year,Seson'),default='')
    player_type = db.StringProperty(verbose_name=_('Player Type'),choices=('Field','GK'),default='')
    player_name = db.StringProperty(verbose_name=_('Player Name'),default='')
    ...
    game_count = db.IntegerProperty(verbose_name=_('Game Count'))
    goal_get = db.IntegerProperty(verbose_name=_('Goal Get'))
    assist = db.IntegerProperty(verbose_name=_('Assist'))
    shoot = db.IntegerProperty(verbose_name=_('Shoot'),default=0)
    passn = db.IntegerProperty(verbose_name=_('Pass'),default=0)
    dribble = db.IntegerProperty(verbose_name=_('dribble'),default=0)
    tackle = db.IntegerProperty(verbose_name=_('Tackle'),default=0)
    clear = db.IntegerProperty(verbose_name=_('Clear'),default=0)
    intercept = db.IntegerProperty(verbose_name=_('Intercept'),default=0)
    save_count = db.IntegerProperty(verbose_name=_('Save count'),default=0)
    save_ratio = db.FloatProperty(verbose_name=_('Save Ratio'),default=0.0)
    catch = db.IntegerProperty(verbose_name=_('Catch'),default=0)
    punch = db.IntegerProperty(verbose_name=_('Punch'),default=0)
    feed_throw = db.FloatProperty(verbose_name=_('Feed Throw'),default=0.0)
    feed_kick = db.FloatProperty(verbose_name=_('Feed Kick'),default=0.0)
    update = db.DateTimeProperty(verbose_name=_('Update'),auto_now=True)
    created = db.DateTimeProperty(verbose_name=_('Created'),auto_now_add=True)
